...
mod tests {
    ...
    use rp2350_sim::cortex_m33::{self, Register};

    struct Registers<'a, T: cortex_m33::SpControl> {
        register_numbers: &'a [Register<T>]
    }

    impl<T: cortex_m33::SpControl> Registers<'_, T> {
        fn binary(&self) -> u16 {
            let mut binary = 0;
    ...
    impl<'a, T: cortex_m33::SpControl> From<&'a [Register<T>]> for Registers<'a, T> {
    ...
    impl<'a, T: cortex_m33::SpControl> Into<&'a [Register<T>]> for Registers<'a, T> {
    ...
    struct Push;
    impl Push {
        fn opcode<T: cortex_m33::SpControl>(push_to_lr: bool, registers: Registers<T>) -> u16 {
    ...
    impl AddRegisterSpPlusImmediate {
        ...
        fn opcode<T: cortex_m33::SpControl>(rd: Register<T>, imm8: u16) -> u16 {
    ...
    struct AddRegister;
    impl AddRegister {
        fn opcode<T: cortex_m33::SpControl, U: cortex_m33::SpControl>(rdn: Register<T>, rm: Register<U>) -> u16 {
    ...
    struct Mov;
    impl Mov {
        fn opcode<T: cortex_m33::SpControl, U: cortex_m33::SpControl>(rd: Register<T>, rm: Register<U>) -> u16 {
    ...
    struct Ldmia;
    impl Ldmia {
        fn opcode<T: cortex_m33::SpControl>(rn: Register<T>, registers: Registers<T>) -> u16 {
    ...
    struct Rev;
    impl Rev {
        fn opcode<T: cortex_m33::SpControl, U: cortex_m33::SpControl>(rd: Register<T>, rn: Register<U>) -> u16 {
    ...
    struct Blx;
    impl Blx {
        fn opcode<T: cortex_m33::SpControl>(rm: Register<T>) -> u16 {
